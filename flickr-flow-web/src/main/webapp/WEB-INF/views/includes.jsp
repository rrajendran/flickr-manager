...
<link rel="stylesheet" type="text/css" href="<c:url value="/static/scripts/lightbox/css/lightbox.css" />" media="all">
...
<script src="<c:url value="/static/scripts/custom.js" />"></script>
